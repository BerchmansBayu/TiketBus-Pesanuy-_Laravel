...
" onmouseover="this.style.backgroundColor='#0056b3';" onmouseout="this.style.backgroundColor='#007BFF';">Login</button>
                    ...
                    <div class="login-signup">
                        <span class="text">Belum Punya Akun ? <a href="{{ route('register') }}" class="text signup-text">Daftar Sekarang</a></span><br>
                        <span class="text">Login User <a href="{{ route('loginuser') }}" class="text signup-text">Login user</a></span>
                    </div>
                    </form>
                </div>
            </div>
