...
<body>
    ...
    <nav>
        ...
        @if(Auth::check())
            <div class="nav_user">Welcome, {{ Auth::user()->nama_pengguna }}</div>
...
<a href="{{ route('actionlogout') }}"
   onclick="event.preventDefault();
    ...
    Logout
        ...
        @else
            <a href="{{ route('actionlogin') }}" class="btn">Masuk/Daftar</a>
        @endif
    </nav>
    ...
    <header class="section_container header_container">
        ...
        <div class="carousel">
            ...
            <div class="navigation-buttons" style="display: flex; justify-content: center; margin-top: 10px;">
