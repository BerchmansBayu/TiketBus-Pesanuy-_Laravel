...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Jun 2024 pada 15.35
...
INSERT INTO `pengguna` (`id_pengguna`, `nama_pengguna`, `email_pengguna`, `password`, `created_at`, `updated_at`, `remember_token`) VALUES
(2, 'aaaa', 'aa@aa.com', '111', '2024-06-05 06:55:46', '2024-06-05 06:55:46', ''),
(3, 'admin', 'admin@admin.com', 'bayu', '2024-06-05 13:35:25', '2024-06-05 13:35:25', NULL);
...
--
ALTER TABLE `buses`
  ADD CONSTRAINT `buses_ibfk_1` FOREIGN KEY (`id_bus`) REFERENCES `rutes` (`id_bus`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `rutes`
--
ALTER TABLE `rutes`
  ADD CONSTRAINT `rutes_ibfk_1` FOREIGN KEY (`id_rute`) REFERENCES `pesanans` (`id_rute`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `terminals`
--
ALTER TABLE `terminals`
  ADD CONSTRAINT `terminals_ibfk_1` FOREIGN KEY (`id_terminal`) REFERENCES `rutes` (`id_terminal`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
